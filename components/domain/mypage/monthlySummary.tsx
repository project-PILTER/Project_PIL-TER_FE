...
export default function MonthlySummary({ summary }: MonthlySummaryProps) {
  ...
  return (
    <Card className="p-6 border border-gray-100 shadow-sm rounded-2xl h-full flex flex-col justify-between">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <div className="flex justify-between text-sm gap-4">
              <span className="text-gray-500 dark:text-[#686b85] font-medium">
                이번 달 작성 게시글
              </span>
              <span className="text-gray-900 dark:text-white font-bold">
                {summary.currentPosts}{" "}
                <span className="text-gray-400 dark:text-white font-normal">
            ...
            <Progress
              ...
              className="h-3 w-full bg-gray-100 dark:bg-[#292a4b] [&>div]:bg-[#5c59da]"
            />
          </div>
      ...
      <div className="rounded-xl p-4 flex justify-between items-center bg-violet-50 dark:bg-[#141529]">
        <HeartPulse className="w-4 h-4 text-[#5c59da] dark:text-[#686b85]" />
        <span className="text-sm text-gray-600 dark:text-[#686b85] font-medium">
          이번 달 건강 기록 달성률
        </span>
